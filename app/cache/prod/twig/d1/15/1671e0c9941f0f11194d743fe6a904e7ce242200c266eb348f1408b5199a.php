...
";
        ...
        if (((($this->getAttribute($_admin_, "hasroute", array(0 => "show"), "method") && $this->getAttribute($_admin_, "id", array(0 => $_object_), "method")) && $this->getAttribute($_admin_, "isGranted", array(0 => "VIEW", 1 => $_object_), "method")) && (twig_length_filter($this->env, $this->getAttribute($_admin_, "show")) > 0))) {
            // line 13
