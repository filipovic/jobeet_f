...
class __TwigTemplate_04798926347a16b3639aa1766f7947447ca8a9a7f23d65d88678ab63a4e08f04 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($_admin_, "isGranted", array(0 => "EDIT", 1 => $_object_), "method") && $this->getAttribute($_admin_, "hasRoute", array(0 => "deactivate"), "method"))) {
            // line 2
            echo "    <a href=\"";
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "generateObjectUrl", array(0 => "deactivate", 1 => $_object_), "method"), "html", null, true);
