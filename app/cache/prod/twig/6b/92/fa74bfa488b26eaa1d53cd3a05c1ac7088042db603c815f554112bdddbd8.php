...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["field_description"]) {
                ...
                echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($_form_, $this->getAttribute($_field_description_, "name"), array(), "array"), 'row');
                echo "
    ";
            }
        ...
        ";
            ...
            if (($this->getAttribute($_sonata_admin_, "edit") == "list")) {
                ...
                // line 22
                if (isset($context["sonata_admin"])) { $_sonata_admin_ = $context["sonata_admin"]; } else { $_sonata_admin_ = null; }
                if ($this->getAttribute($this->getAttribute($_sonata_admin_, "admin"), "id", array(0 => $this->getAttribute($_sonata_admin_, "value")), "method")) {
                    // line 23
                    echo "                    ";
                    if (isset($context["sonata_admin"])) { $_sonata_admin_ = $context["sonata_admin"]; } else { $_sonata_admin_ = null; }
