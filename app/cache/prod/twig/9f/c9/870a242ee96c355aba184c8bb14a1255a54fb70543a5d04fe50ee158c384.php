...
class __TwigTemplate_9fc9870a242ee96c355aba184c8bb14a1255a54fb70543a5d04fe50ee158c384 extends Twig_Template
{
...
";
        ...
        if ((($this->getAttribute($_admin_, "hasroute", array(0 => "history"), "method") && $this->getAttribute($_admin_, "id", array(0 => $_object_), "method")) && $this->getAttribute($_admin_, "isGranted", array(0 => "EDIT", 1 => $_object_), "method"))) {
            // line 13
            echo "    <a class=\"btn sonata-action-element\" href=\"";
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "generateObjectUrl", array(0 => "history", 1 => $_object_), "method"), "html", null, true);
            echo "\">
        <i class=\"icon-book\"></i>
        ";
            // line 15
