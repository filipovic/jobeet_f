...
class __TwigTemplate_ce0f168e833a2cb91a4fe1410328dec6581d5fa7704070be7b7945345d0cee16 extends Twig_Template
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("message_delete_confirmation", array("%object%" => $this->getAttribute($_admin_, "toString", array(0 => $_object_), "method")), "SonataAdminBundle"), "html", null, true);
        echo "
        ...
        if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
        if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
        if (($this->getAttribute($_admin_, "hasRoute", array(0 => "edit"), "method") && $this->getAttribute($_admin_, "isGranted", array(0 => "EDIT", 1 => $_object_), "method"))) {
            // line 38
            echo "                    ";
            ...
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "generateObjectUrl", array(0 => "edit", 1 => $_object_), "method"), "html", null, true);
            echo "\">
