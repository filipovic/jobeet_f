...
class __TwigTemplate_8d0840c2f0d756674f0943df602c1d258216ff328c5e2f71ca5c98eff84ca1be extends Twig_Template
{
    ...
    public function block_field($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($this->getAttribute($_field_description_, "options"), "choices") && twig_in_filter($_value_, twig_get_array_keys_filter($this->getAttribute($this->getAttribute($_field_description_, "options"), "choices"))))) {
            // line 15
            echo "        ";
            if (isset($context["field_description"])) { $_field_description_ = $context["field_description"]; } else { $_field_description_ = null; }
    ...
    ";
        // line 22
        if (isset($context["field_description"])) { $_field_description_ = $context["field_description"]; } else { $_field_description_ = null; }
        if ($this->getAttribute($this->getAttribute($_field_description_, "options"), "safe")) {
            // line 23
            echo "        ";
            if (isset($context["value"])) { $_value_ = $context["value"]; } else { $_value_ = null; }
            echo $_value_;
