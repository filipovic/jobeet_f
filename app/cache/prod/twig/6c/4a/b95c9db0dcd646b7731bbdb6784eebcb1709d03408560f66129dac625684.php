...
class __TwigTemplate_6c4ab95c9db0dcd646b7731bbdb6784eebcb1709d03408560f66129dac625684 extends Twig_Template
{
...
";
        ...
        if ($this->getAttribute($_admin_, "hasRoute", array(0 => "show"), "method")) {
            // line 13
            echo "    <a href=\"";
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "generateObjectUrl", array(0 => "show", 1 => $_object_), "method"), "html", null, true);
