...
class __TwigTemplate_a6d62fd491362876773324ad11e5cb465ae5c40a502539af9ac08bf9282a440a extends Twig_Template
{
    ...
    public function block_field($context, array $blocks = array())
    {
        ...
        if ((!$this->getAttribute($this->getAttribute($_field_description_, "options", array(), "any", false, true), "catalogue", array(), "any", true, true))) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($_value_), "html", null, true);
            echo "
    ";
        } else {
            // line 18
            ...
            if (isset($context["value"])) { $_value_ = $context["value"]; } else { $_value_ = null; }
            if (isset($context["field_description"])) { $_field_description_ = $context["field_description"]; } else { $_field_description_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($_value_, array(), $this->getAttribute($this->getAttribute($_field_description_, "options"), "catalogue")), "html", null, true);
            echo "
    ";
        }
    }
