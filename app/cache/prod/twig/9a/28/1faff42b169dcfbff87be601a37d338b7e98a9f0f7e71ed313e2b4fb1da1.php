...
class __TwigTemplate_9a281faff42b169dcfbff87be601a37d338b7e98a9f0f7e71ed313e2b4fb1da1 extends Twig_Template
{
...
<div>
    ...
    <div class=\"sonata-ba-field";
        // line 23
        if (isset($context["filter_form"])) { $_filter_form_ = $context["filter_form"]; } else { $_filter_form_ = null; }
        if ($this->getAttribute($this->getAttribute($_filter_form_, "vars"), "errors")) {
...
";
    ...
    public function block_label($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute($_filter_, "fielddescription", array(), "any", false, true), "options", array(), "any", false, true), "name", array(), "any", true, true)) {
            // line 16
            echo "            ";
            if (isset($context["filter_form"])) { $_filter_form_ = $context["filter_form"]; } else { $_filter_form_ = null; }
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($_filter_form_, 'label', (twig_test_empty($_label_ = $this->getAttribute($this->getAttribute($this->getAttribute($_filter_, "fielddescription"), "options"), "name")) ? array() : array("label" => $_label_)));
            echo "
        ";
        } else {
            // line 18
            echo "            ";
            if (isset($context["filter_form"])) { $_filter_form_ = $context["filter_form"]; } else { $_filter_form_ = null; }
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($_filter_form_, 'label');
            echo "
        ";
        }
        // line 20
    ...
    {
        if (isset($context["filter_form"])) { $_filter_form_ = $context["filter_form"]; } else { $_filter_form_ = null; }
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($_filter_form_, 'widget');
    }
