    ...
    ";
            ...
            <ul class=\"dropdown-menu\">
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subclass"]) {
                    ...
                    if (isset($context["subclass"])) { $_subclass_ = $context["subclass"]; } else { $_subclass_ = null; }
                    if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($_subclass_, array(), $this->getAttribute($_admin_, "translationdomain")), "html", null, true);
                    echo "</a>
                    </li>
                ";
                }
