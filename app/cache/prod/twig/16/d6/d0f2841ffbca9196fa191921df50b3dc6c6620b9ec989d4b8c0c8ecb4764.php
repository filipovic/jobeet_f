...
class __TwigTemplate_16d6d0f2841ffbca9196fa191921df50b3dc6c6620b9ec989d4b8c0c8ecb4764 extends Twig_Template
{
...
";
        ...
        if (($this->getAttribute($this->getAttribute($_admin_, "list"), "has", array(0 => "batch"), "method") && (!$this->getAttribute($this->getAttribute($_app_, "request"), "isXmlHttpRequest")))) {
            // line 13
        ...
        ";
            ...
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            echo $this->env->getExtension('sonata_admin')->renderListElement($_object_, $this->getAttribute($this->getAttribute($_admin_, "list"), "batch", array(), "array"));
            echo "
    </td>
";
        }
...
<td class=\"sonata-ba-list-field sonata-ba-list-field-inline-fields\" colspan=\"";
        // line 18
        if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
        echo twig_escape_filter($this->env, (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_admin_, "list"), "elements")) - ($this->getAttribute($this->getAttribute($_admin_, "list"), "has", array(0 => "_action"), "method") + $this->getAttribute($this->getAttribute($_admin_, "list"), "has", array(0 => "batch"), "method"))), "html", null, true);
        echo "\">
    ";
        // line 19
...
";
        ...
        if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($this->getAttribute($_admin_, "list"), "has", array(0 => "_action"), "method") && (!$this->getAttribute($this->getAttribute($_app_, "request"), "isXmlHttpRequest")))) {
            // line 23
        ...
        ";
            ...
            if (isset($context["object"])) { $_object_ = $context["object"]; } else { $_object_ = null; }
            if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
            echo $this->env->getExtension('sonata_admin')->renderListElement($_object_, $this->getAttribute($this->getAttribute($_admin_, "list"), "_action", array(), "array"));
            echo "
    </td>
";
        }
