...
class appTestUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/ens_job')) {
            ...
            // ens_job_edit
            if (preg_match('#^/ens_job/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
            ...
            // ens_job_update
            if (preg_match('#^/ens_job/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
            ...
            // ens_job_delete
            if (preg_match('#^/ens_job/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
