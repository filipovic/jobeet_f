...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ens.jobeet.admin.affiliate' => 'getEns_Jobeet_Admin_AffiliateService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_aa2ce6ff4e8a9d6966cb5520bb328df6');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_aa2ce6ff4e8a9d6966cb5520bb328df6');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_aa2ce6ff4e8a9d6966cb5520bb328df6');
    ...
    /**
     * Gets the 'ens.jobeet.admin.affiliate' service.
     *
     * @return Ens\JobeetBundle\Admin\AffiliateAdmin A Ens\JobeetBundle\Admin\AffiliateAdmin instance.
     */
    protected function getEns_Jobeet_Admin_AffiliateService()
    {
        $instance = new \Ens\JobeetBundle\Admin\AffiliateAdmin('ens.jobeet.admin.affiliate', 'Ens\\JobeetBundle\\Entity\\Affiliate', 'EnsJobeetBundle:AffiliateAdmin');
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/jobeet/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/jobeet/app/cache/dev/sessions');
    }
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Jobeet Admin', 'bundles/sonataadmin/logo_title.png', array('html5_validate' => true, 'confirm_exit' => true, 'use_select2' => true));
        ...
        $instance->setAdminServiceIds(array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job', 2 => 'ens.jobeet.admin.affiliate'));
        $instance->setAdminGroups(array('jobeet' => array('label' => 'jobeet', 'label_catalogue' => 'SonataAdminBundle', 'roles' => array(), 'items' => array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job', 2 => 'ens.jobeet.admin.affiliate'))));
        $instance->setAdminClasses(array('Ens\\JobeetBundle\\Entity\\Category' => 'ens.jobeet.admin.category', 'Ens\\JobeetBundle\\Entity\\Job' => 'ens.jobeet.admin.job', 'Ens\\JobeetBundle\\Entity\\Affiliate' => 'ens.jobeet.admin.affiliate'));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job', 2 => 'ens.jobeet.admin.affiliate'), $this);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setUsername('filipe.matos.teste@gmail.com');
        $instance->setPassword('filipe11');
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/jobeet/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('xlf', '/var/www/jobeet/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ua.xlf', 'ua', 'validators');
        ...
        $instance->addResource('xlf', '/var/www/jobeet/src/Ens/JobeetBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.en.xliff', 'en', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.lb.xliff', 'lb', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.bg.xliff', 'bg', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.cs.xliff', 'cs', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.ru.xliff', 'ru', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.de.xliff', 'de', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.nl.xliff', 'nl', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.ca.xliff', 'ca', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.pt.xliff', 'pt', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.sl.xliff', 'sl', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.zh_CN.xliff', 'zh_CN', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.ro.xliff', 'ro', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.pt_BR.xliff', 'pt_BR', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.it.xliff', 'it', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.hu.xliff', 'hu', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.es.xliff', 'es', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.ja.xliff', 'ja', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.eu.xliff', 'eu', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.pl.xliff', 'pl', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.uk.xliff', 'uk', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.sk.xliff', 'sk', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.hr.xliff', 'hr', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/translations/SonataAdminBundle.fa.xliff', 'fa', 'SonataAdminBundle');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/jobeet/vendor/sonata-project/block-bundle/Sonata/BlockBundle/Resources/views', 'SonataBlock');
        $instance->addPath('/var/www/jobeet/vendor/sonata-project/doctrine-orm-admin-bundle/Sonata/DoctrineORMAdminBundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('/var/www/jobeet/app/Resources/SonataAdminBundle/views', 'SonataAdmin');
        $instance->addPath('/var/www/jobeet/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/views', 'SonataAdmin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'filipe',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'filipe.matos.teste@gmail.com',
            'mailer_password' => 'filipe11',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'filipe.matos.teste@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'filipe11',
